...
class Database:
    ...
    def get_paiements_client(self, client_id):
        self.c.execute('SELECT * FROM paiements WHERE client_id = %s ORDER BY date_paiement DESC', (client_id,))
        return self.c.fetchall()
    ...
    def attribuer_voyage_client(self, client_id, voyage_id):
        self.c.execute('''
            INSERT INTO client_voyage (client_id, voyage_id, date_attribution)
